    ...
    <div className="container py-4 py-md-5">
      ...
      <div className="row g-5">
        ...
        <div className="col-lg-7">
          ...
          {/* Size + Quantity — same row, 30px gap */}
          <div className="d-flex flex-wrap align-items-start mb-4" style={{ gap: 30 }}>
            {/* Size selector */}
          ...
          {/* Actions — all 3 on one row */}
          <div className="d-flex gap-2 mb-3" style={{ maxWidth: "640px" }}>
            <button
            ...
            >
              {isOutOfStock ? (
                ...
                <><span className="spinner-border spinner-border-sm" style={{ borderWidth: "2px" }} />Adding...</>
              ) : addedToCart ? (
                <><i className="bi bi-check2-circle" />Added!</>
              ) : (
                <><i className="bi bi-bag-plus" />Add to Cart</>
              )}
            </button>

            <button className="btn-whatsapp" style={{ flex: "1 1 0" }} onClick={handleWhatsApp}>
      ...
      <div style={{
        ...
        background: "white",
        borderTop: "1px solid rgba(159,82,58,0.12)",
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", display: "flex", gap: 10, alignItems: "center" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, flex: 1, minWidth: 0, overflow: "hidden" }}>
            {product.images[0] && (
              <div style={{ width: 42, height: 52, borderRadius: 8, overflow: "hidden", flexShrink: 0, border: "1px solid #f0ede9" }}>
                <Image src={product.images[0]} alt={product.name} width={42} height={52} style={{ objectFit: "cover", width: "100%", height: "100%" }} />
              </div>
            )}
            <div style={{ minWidth: 0 }}>
              <p style={{ margin: 0, fontWeight: 700, fontSize: "0.85rem", color: "#1a1a1a", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{product.name}</p>
              <p style={{ margin: 0, fontWeight: 800, fontSize: "0.9rem", color: "#9f523a" }}>₹{Number(product.price).toLocaleString("en-IN")}</p>
            </div>
          </div>
          ...
          <button
            ...
            onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.transform = "translateY(-2px)"; (e.currentTarget as HTMLElement).style.boxShadow = "0 4px 14px rgba(37,211,102,0.45)"; }}
            onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.transform = ""; (e.currentTarget as HTMLElement).style.boxShadow = "0 2px 8px rgba(37,211,102,0.35)"; }}
          >
          ...
          <button
            ...
            style={{
              display: "flex", alignItems: "center", justifyContent: "center",
              width: 44, height: 44, flexShrink: 0,
              background: inWishlist ? "rgba(159,82,58,0.1)" : "#f8f5f2",
              border: `1.5px solid ${inWishlist ? "#9f523a" : "#e8e0d8"}`,
              borderRadius: 10, cursor: "pointer",
              color: inWishlist ? "#9f523a" : "#888",
              fontSize: "1.1rem",
              transition: "all 0.2s",
            }}
          ...
          <button
            ...
            style={{
              ...
              background: isOutOfStock ? "#ccc" : addedToCart ? "#20c997" : "linear-gradient(135deg, #9f523a 0%, #7a3f2c 100%)",
              border: "none", borderRadius: 10,
              color: "white", fontWeight: 700, fontSize: "0.9rem",
              cursor: isOutOfStock ? "not-allowed" : "pointer",
              whiteSpace: "nowrap",
              boxShadow: isOutOfStock ? "none" : "0 2px 10px rgba(159,82,58,0.35)",
              transition: "all 0.2s",
            }}
            onMouseEnter={(e) => { if (!isOutOfStock && !adding) (e.currentTarget as HTMLElement).style.transform = "translateY(-2px)"; }}
            onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.transform = ""; }}
          >
            {isOutOfStock ? (
              <><i className="bi bi-slash-circle" /> Out of Stock</>
